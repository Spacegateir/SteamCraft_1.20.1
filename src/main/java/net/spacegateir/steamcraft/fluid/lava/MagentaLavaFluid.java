...
public abstract class MagentaLavaFluid extends FlowableFluid {
    ...
    protected void flow(WorldAccess world, BlockPos pos, BlockState state, Direction direction, FluidState fluidState) {
        ...
        Map<Class<?>, Block> coloredWaterReactions = Map.ofEntries(
                ...
                Map.entry(ModFluidOrange.class, ModBlocks.COBBLED_PURPLE_CONCRETE_POWDER),
                ...
                Map.entry(ModFluidYellow.class, ModBlocks.COBBLED_PINK_CONCRETE_POWDER),
                Map.entry(ModFluidLime.class, ModBlocks.COBBLED_PINK_CONCRETE_POWDER),
                ...
                Map.entry(ModFluidLightGray.class, ModBlocks.COBBLED_PINK_CONCRETE_POWDER),
        ...
        if (direction == Direction.DOWN) {
            ...
            if (this.isIn(ModTags.Fluids.MAGENTA_LAVA_DL) && fluidState2.isIn(ModTags.Fluids.WATER_DL)) {
