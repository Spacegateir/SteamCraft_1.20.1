...
public class ArcaneNightVisionBlock extends Block {
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        if (!world.isClient && entity instanceof LivingEntity livingEntity) {
            ...
            livingEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.NIGHT_VISION, adjustedDuration, adjustedAmplifier, false, false));
        }
