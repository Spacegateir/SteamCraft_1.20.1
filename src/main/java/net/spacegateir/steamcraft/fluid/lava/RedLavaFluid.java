...
public abstract class RedLavaFluid extends FlowableFluid {
    ...
    protected void flow(WorldAccess world, BlockPos pos, BlockState state, Direction direction, FluidState fluidState) {
        ...
        Map<Class<?>, Block> coloredWaterReactions = Map.ofEntries(
                ...
                Map.entry(ModFluidYellow.class, ModBlocks.COBBLED_ORANGE_CONCRETE_POWDER),
                Map.entry(ModFluidLime.class, ModBlocks.COBBLED_BROWN_CONCRETE_POWDER),
                Map.entry(ModFluidPink.class, ModBlocks.COBBLED_RED_CONCRETE_POWDER),
                ...
                Map.entry(ModFluidGreen.class, ModBlocks.COBBLED_BROWN_CONCRETE_POWDER),
        ...
        if (direction == Direction.DOWN) {
            ...
            if (this.isIn(ModTags.Fluids.RED_LAVA_DL) && fluidState2.isIn(ModTags.Fluids.WATER_DL)) {
