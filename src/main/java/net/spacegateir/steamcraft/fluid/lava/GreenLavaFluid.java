...
public abstract class GreenLavaFluid extends FlowableFluid {
    ...
    protected void flow(WorldAccess world, BlockPos pos, BlockState state, Direction direction, FluidState fluidState) {
        ...
        Map<Class<?>, Block> coloredWaterReactions = Map.ofEntries(
                Map.entry(ModFluidWhite.class, ModBlocks.COBBLED_LIME_CONCRETE_POWDER),
                Map.entry(ModFluidOrange.class, ModBlocks.COBBLED_BROWN_CONCRETE_POWDER),
                Map.entry(ModFluidMagenta.class, ModBlocks.COBBLED_PURPLE_CONCRETE_POWDER),
                Map.entry(ModFluidLightBlue.class, ModBlocks.COBBLED_CYAN_CONCRETE_POWDER),
                Map.entry(ModFluidYellow.class, ModBlocks.COBBLED_LIME_CONCRETE_POWDER),
                Map.entry(ModFluidLime.class, ModBlocks.COBBLED_GREEN_CONCRETE_POWDER),
                ...
                Map.entry(ModFluidLightGray.class, ModBlocks.COBBLED_GREEN_CONCRETE_POWDER),
                ...
                Map.entry(ModFluidBlue.class, ModBlocks.COBBLED_CYAN_CONCRETE_POWDER),
                ...
                Map.entry(ModFluidRed.class, ModBlocks.COBBLED_BROWN_CONCRETE_POWDER),
        ...
        if (direction == Direction.DOWN) {
            ...
            if (this.isIn(ModTags.Fluids.GREEN_LAVA_DL) && fluidState2.isIn(ModTags.Fluids.WATER_DL)) {
