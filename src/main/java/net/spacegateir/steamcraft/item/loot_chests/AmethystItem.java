...
public class AmethystItem extends Item {
    ...
    public AmethystItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        if (!world.isClient) {
            List<ItemConvertible> lootItems = List.of(
                    ModRewardItems.AMETHYST_HELMET,
                    ModRewardItems.AMETHYST_CHESTPLATE,
                    ModRewardItems.AMETHYST_LEGGINGS,
                    ModRewardItems.AMETHYST_BOOTS
            );
