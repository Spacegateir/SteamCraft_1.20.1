...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.WHITE_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.WHITE_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.LIGHT_GRAY_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.LIGHT_GRAY_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.GRAY_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.GRAY_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.BLACK_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.BLACK_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.BROWN_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.BROWN_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.RED_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.RED_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.ORANGE_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.ORANGE_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.YELLOW_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.YELLOW_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.LIME_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.LIME_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.GREEN_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.GREEN_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.CYAN_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.CYAN_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.LIGHT_BLUE_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.LIGHT_BLUE_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.BLUE_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.BLUE_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.PURPLE_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.PURPLE_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.MAGENTA_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.MAGENTA_COBBLED_CONCRETE_POWDER);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.PINK_COBBLED_CONCRETE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.PINK_COBBLED_CONCRETE_POWDER);
