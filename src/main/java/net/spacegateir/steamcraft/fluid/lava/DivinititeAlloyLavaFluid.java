...
public abstract class DivinititeAlloyLavaFluid extends FlowableFluid {
    public static final float MIN_HEIGHT_TO_REPLACE = 0.44444445F;

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_DIVINITITE_ALLOY_LAVA;
    }

    @Override
    public Fluid getStill() {
        return ModFluids.STILL_DIVINITITE_ALLOY_LAVA;
    }

    @Override
    public Item getBucketItem() {
        return ModItems.DIVINITITE_ALLOY_LAVA_BUCKET;
    }
    ...
    protected void flow(WorldAccess world, BlockPos pos, BlockState state, Direction direction, FluidState fluidState) {
        ...
        if (direction == Direction.DOWN) {
            ...
            if (this.isIn(ModTags.Fluids.DIVINITITE_ALLOY_MM) && fluidState2.isIn(ModTags.Fluids.WATER_DL)) {
    ...
    public BlockState toBlockState(FluidState state) {
        return ModFluids.DIVINITITE_ALLOY_LAVA_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }

    // Subclasses

    public static class Flowing extends DivinititeAlloyLavaFluid {
        @Override
    ...
    public static class Still extends DivinititeAlloyLavaFluid {
        @Override
        public int getLevel(FluidState state) {
            return 8;
        }
