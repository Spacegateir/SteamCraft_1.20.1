...
public class ArcaneSlownessBlock extends ArcaneBlock {
    ...
    public ArcaneSlownessBlock(Settings settings) {
        super(settings, signalStrength -> new StatusEffectInstance(StatusEffects.SLOWNESS, signalStrength * 200 + 200, signalStrength, false, false));
