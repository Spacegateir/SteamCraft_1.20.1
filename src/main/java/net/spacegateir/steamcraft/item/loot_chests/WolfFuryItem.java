...
public class WolfFuryItem extends Item {
    public WolfFuryItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        if (!world.isClient) {
            List<ItemConvertible> lootItems = List.of(
                    ModRewardItems.WOLF_FURY_HELMET,
                    ModRewardItems.WOLF_FURY_CHESTPLATE,
                    ModRewardItems.WOLF_FURY_LEGGINGS,
                    ModRewardItems.WOLF_FURY_BOOTS
            );
