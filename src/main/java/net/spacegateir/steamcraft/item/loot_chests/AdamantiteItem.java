...
public class AdamantiteItem extends Item {

    public AdamantiteItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        if (!world.isClient) {
            List<ItemConvertible> lootItems = List.of(
                    ModRewardItems.ADAMANTITE_HELMET,
                    ModRewardItems.ADAMANTITE_CHESTPLATE,
                    ModRewardItems.ADAMANTITE_LEGGINGS,
                    ModRewardItems.ADAMANTITE_BOOTS
            );
