...
public class MythrilItem extends Item {
    ...
    public MythrilItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        if (!world.isClient) {
            List<ItemConvertible> lootItems = List.of(
                    ModRewardItems.MYTHRIL_HELMET,
                    ModRewardItems.MYTHRIL_CHESTPLATE,
                    ModRewardItems.MYTHRIL_LEGGINGS,
                    ModRewardItems.MYTHRIL_BOOTS
            );
