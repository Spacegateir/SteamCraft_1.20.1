...
public class StonePathBlock extends Block {
    ...
    public StonePathBlock(Settings settings) {
        super(settings);
    }
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        return !this.getDefaultState().canPlaceAt(ctx.getWorld(), ctx.getBlockPos())
                ? Block.pushEntitiesUpBeforeBlockChange(this.getDefaultState(), Blocks.STONE.getDefaultState(), ctx.getWorld(), ctx.getBlockPos())
