...
public class ArcaneInstantHealthBlock extends Block {
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        if (!world.isClient && entity instanceof LivingEntity livingEntity) {
            ...
            int baseDuration = (signalStrength == 0) ? 1200 : 1200;
            ...
            livingEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.INSTANT_HEALTH, adjustedDuration, adjustedAmplifier, false, false));
        }
