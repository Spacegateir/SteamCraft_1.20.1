...
public class ArcaneNeauseaBlock extends Block {
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        if (!world.isClient && entity instanceof LivingEntity livingEntity) {
            ...
            livingEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, adjustedDuration, adjustedAmplifier, false, false));
        }
