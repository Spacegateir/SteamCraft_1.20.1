...
public class DwarfSteelItem extends Item {

    public DwarfSteelItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        if (!world.isClient) {
            List<ItemConvertible> lootItems = List.of(
                    ModRewardItems.DWARF_STEEL_HELMET,
                    ModRewardItems.DWARF_STEEL_CHESTPLATE,
                    ModRewardItems.DWARF_STEEL_LEGGINGS,
                    ModRewardItems.DWARF_STEEL_BOOTS
            );
