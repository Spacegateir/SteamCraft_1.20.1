...
public class DyedFluidBlock extends Block implements FluidDrainable {
    ...
    public DyedFluidBlock(FlowableFluid fluid, DyeColor color, Settings settings) {
        super(settings);
        this.fluid = fluid;
    ...
    private boolean receiveNeighborFluids(World world, BlockPos pos, BlockState state) {
        if (this.fluid.isIn(ModTags.Fluids.LAVA_DL)) {
            ...
            for (Direction direction : FLOW_DIRECTIONS) {
                ...
                if (world.getFluidState(blockPos).isIn(waterTag)) {
