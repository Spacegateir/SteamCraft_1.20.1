...
public class ClearNegativeStatusEffect extends StatusEffect {
    ...
    public ClearNegativeStatusEffect(StatusEffectCategory category, int color) {
    ...
    public void applyUpdateEffect(LivingEntity entity, int amplifier) {
        ...
        entity.getActiveStatusEffects().keySet().stream()
                .filter(effect -> effect.getCategory() == StatusEffectCategory.HARMFUL) // Filter neutral effects
