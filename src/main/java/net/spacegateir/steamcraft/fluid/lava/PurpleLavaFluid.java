...
public abstract class PurpleLavaFluid extends FlowableFluid {
    ...
    protected void flow(WorldAccess world, BlockPos pos, BlockState state, Direction direction, FluidState fluidState) {
        ...
        Map<Class<?>, Block> coloredWaterReactions = Map.ofEntries(
                Map.entry(ModFluidWhite.class, ModBlocks.COBBLED_PINK_CONCRETE_POWDER),
                Map.entry(ModFluidOrange.class, ModBlocks.COBBLED_MAGENTA_CONCRETE_POWDER),
                Map.entry(ModFluidMagenta.class, ModBlocks.COBBLED_PURPLE_CONCRETE_POWDER),
                Map.entry(ModFluidLightBlue.class, ModBlocks.COBBLED_PURPLE_CONCRETE_POWDER),
                Map.entry(ModFluidYellow.class, ModBlocks.COBBLED_MAGENTA_CONCRETE_POWDER),
                Map.entry(ModFluidLime.class, ModBlocks.COBBLED_CYAN_CONCRETE_POWDER),
                Map.entry(ModFluidPink.class, ModBlocks.COBBLED_MAGENTA_CONCRETE_POWDER),
                Map.entry(ModFluidGray.class, ModBlocks.COBBLED_PURPLE_CONCRETE_POWDER),
                Map.entry(ModFluidLightGray.class, ModBlocks.COBBLED_LIGHT_GRAY_CONCRETE_POWDER),
                Map.entry(ModFluidCyan.class, ModBlocks.COBBLED_PURPLE_CONCRETE_POWDER),
                ...
                Map.entry(ModFluidBrown.class, ModBlocks.COBBLED_MAGENTA_CONCRETE_POWDER),
                Map.entry(ModFluidGreen.class, ModBlocks.COBBLED_LIME_CONCRETE_POWDER),
                Map.entry(ModFluidRed.class, ModBlocks.COBBLED_MAGENTA_CONCRETE_POWDER),
                Map.entry(ModFluidBlack.class, ModBlocks.COBBLED_PURPLE_CONCRETE_POWDER)
        );
        ...
        if (direction == Direction.DOWN) {
            ...
            if (this.isIn(ModTags.Fluids.PURPLE_LAVA_DL) && fluidState2.isIn(ModTags.Fluids.WATER_DL)) {
