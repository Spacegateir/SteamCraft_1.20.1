...
public class ClearNeutralStatusEffect extends StatusEffect {
    ...
    public ClearNeutralStatusEffect(StatusEffectCategory category, int color) {
    ...
    public void applyUpdateEffect(LivingEntity entity, int amplifier) {
        ...
        entity.getActiveStatusEffects().keySet().stream()
                .filter(effect -> effect.getCategory() == StatusEffectCategory.NEUTRAL) // Filter neutral effects
