...
public abstract class LimeLavaFluid extends FlowableFluid {
    ...
    protected void flow(WorldAccess world, BlockPos pos, BlockState state, Direction direction, FluidState fluidState) {
        ...
        Map<Class<?>, Block> coloredWaterReactions = Map.ofEntries(
                Map.entry(ModFluidWhite.class, ModBlocks.COBBLED_LIGHT_GRAY_CONCRETE_POWDER),
                ...
                Map.entry(ModFluidGray.class, ModBlocks.COBBLED_GREEN_CONCRETE_POWDER),
                ...
                Map.entry(ModFluidBrown.class, ModBlocks.COBBLED_GREEN_CONCRETE_POWDER),
        ...
        if (direction == Direction.DOWN) {
            ...
            if (this.isIn(ModTags.Fluids.LIME_LAVA_DL) && fluidState2.isIn(ModTags.Fluids.WATER_DL)) {
