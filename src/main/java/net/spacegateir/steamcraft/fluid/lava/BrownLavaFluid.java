...
public abstract class BrownLavaFluid extends FlowableFluid {
    ...
    protected void flow(WorldAccess world, BlockPos pos, BlockState state, Direction direction, FluidState fluidState) {
        ...
        Map<Class<?>, Block> coloredWaterReactions = Map.ofEntries(
                Map.entry(ModFluidWhite.class, ModBlocks.COBBLED_LIGHT_GRAY_CONCRETE_POWDER),   // Brown + White ≈ Light Gray (Beige)
                Map.entry(ModFluidOrange.class, ModBlocks.COBBLED_BROWN_CONCRETE_POWDER),       // Brown + Orange ≈ Brown
                Map.entry(ModFluidMagenta.class, ModBlocks.COBBLED_PURPLE_CONCRETE_POWDER),     // Brown + Magenta ≈ Purple
                Map.entry(ModFluidLightBlue.class, ModBlocks.COBBLED_CYAN_CONCRETE_POWDER),     // Brown + Light Blue ≈ Cyan
                Map.entry(ModFluidYellow.class, ModBlocks.COBBLED_ORANGE_CONCRETE_POWDER),      // Brown + Yellow ≈ Orange
                Map.entry(ModFluidLime.class, ModBlocks.COBBLED_GREEN_CONCRETE_POWDER),         // Brown + Lime ≈ Green
                Map.entry(ModFluidPink.class, ModBlocks.COBBLED_MAGENTA_CONCRETE_POWDER),       // Brown + Pink ≈ Magenta
                Map.entry(ModFluidGray.class, ModBlocks.COBBLED_GRAY_CONCRETE_POWDER),          // Brown + Gray = Gray
                Map.entry(ModFluidLightGray.class, ModBlocks.COBBLED_LIGHT_GRAY_CONCRETE_POWDER),// Brown + Light Gray ≈ Light Gray
                Map.entry(ModFluidCyan.class, ModBlocks.COBBLED_CYAN_CONCRETE_POWDER),          // Brown + Cyan = Cyan
                Map.entry(ModFluidPurple.class, ModBlocks.COBBLED_PURPLE_CONCRETE_POWDER),      // Brown + Purple = Purple
                Map.entry(ModFluidBlue.class, ModBlocks.COBBLED_CYAN_CONCRETE_POWDER),          // Brown + Blue ≈ Cyan
                Map.entry(ModFluidBrown.class, ModBlocks.COBBLED_BROWN_CONCRETE_POWDER),        // Brown + Brown = Brown
                Map.entry(ModFluidGreen.class, ModBlocks.COBBLED_GREEN_CONCRETE_POWDER),        // Brown + Green = Green
                Map.entry(ModFluidRed.class, ModBlocks.COBBLED_RED_CONCRETE_POWDER),            // Brown + Red = Red
                Map.entry(ModFluidBlack.class, ModBlocks.COBBLED_GRAY_CONCRETE_POWDER)          // Brown + Black ≈ Gray
        );
        ...
        if (direction == Direction.DOWN) {
            ...
            if (this.isIn(ModTags.Fluids.BROWN_LAVA_DL) && fluidState2.isIn(ModTags.Fluids.WATER_DL)) {
