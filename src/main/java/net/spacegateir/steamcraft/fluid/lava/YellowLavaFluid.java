...
public abstract class YellowLavaFluid extends FlowableFluid {
    ...
    protected void flow(WorldAccess world, BlockPos pos, BlockState state, Direction direction, FluidState fluidState) {
        ...
        Map<Class<?>, Block> coloredWaterReactions = Map.ofEntries(
                ...
                Map.entry(ModFluidLightBlue.class, ModBlocks.COBBLED_LIME_CONCRETE_POWDER),
                ...
                Map.entry(ModFluidCyan.class, ModBlocks.COBBLED_LIME_CONCRETE_POWDER),
                Map.entry(ModFluidPurple.class, ModBlocks.COBBLED_PINK_CONCRETE_POWDER),
                Map.entry(ModFluidBlue.class, ModBlocks.COBBLED_GREEN_CONCRETE_POWDER),
        ...
        if (direction == Direction.DOWN) {
            ...
            if (this.isIn(ModTags.Fluids.YELLOW_LAVA_DL) && fluidState2.isIn(ModTags.Fluids.WATER_DL)) {
