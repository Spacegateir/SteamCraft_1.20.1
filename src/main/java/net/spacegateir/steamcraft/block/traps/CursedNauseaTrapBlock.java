...
public class CursedNauseaTrapBlock extends Block {
    ...
    public CursedNauseaTrapBlock(Settings settings) {
        super(settings);
        ...
        if (!world.isClient) {
            ...
            world.getEntitiesByClass(PlayerEntity.class, effectArea, player -> player.isAlive())
                    .forEach(player -> {
                        ...
                        player.addStatusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 1000, 0, false, false));
