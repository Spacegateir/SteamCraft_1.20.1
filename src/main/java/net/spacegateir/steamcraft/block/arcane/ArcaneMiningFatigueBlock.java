...
public class ArcaneMiningFatigueBlock extends Block {
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        if (!world.isClient && entity instanceof LivingEntity livingEntity) {
            ...
            int baseAmplifier = (signalStrength == 0) ? 0 : 2400;
            ...
            livingEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.MINING_FATIGUE, adjustedDuration, adjustedAmplifier, false, false));
        }
