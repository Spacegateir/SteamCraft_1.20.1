...
public class DragonBaneItem extends Item {

    public DragonBaneItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        if (!world.isClient) {
            List<ItemConvertible> lootItems = List.of(
                    ModRewardItems.DRAGON_BANE_HELMET,
                    ModRewardItems.DRAGON_BANE_CHESTPLATE,
                    ModRewardItems.DRAGON_BANE_LEGGINGS,
                    ModRewardItems.DRAGON_BANE_BOOTS
            );
